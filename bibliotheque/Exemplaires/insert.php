...
<html lang="en">
  ...
  <h1>Ajouter un exemplaire</h1> <br>
      ...
      <form action="insert.php" method="POST">
            ...
            <input type="text" placeholder="Entrez le statut" name="statut">
            <input type="text" placeholder="Entrez le nom de l'emprunteur" name="nom_emprunteur">
            <input type="text" placeholder="Entrez le prénom de l'emprunteur" name="prenom_emprunteur">
        ...
        $req = $bdd->prepare('INSERT INTO exemplaires(titre, statut, nom_emprunteur, prenom_emprunteur) VALUES(?, ?, ?, ?)');
        $req->execute(array(
            $_POST['titre'],
            $_POST['statut'],
